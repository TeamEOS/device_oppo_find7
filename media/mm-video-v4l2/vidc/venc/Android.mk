...
libmm-venc-inc      += device/oppo/find7/media/mm-core/inc
libmm-venc-inc      += device/oppo/find7/media/libstagefrighthw
libmm-venc-inc      += device/oppo/find7/display/libgralloc
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += device/oppo/find7/media/libc2dcolorconvert
libmm-venc-inc      += device/oppo/find7/display/libcopybit
...
mm-venc-test720p-inc            += device/oppo/find7/media/mm-core/inc
mm-venc-test720p-inc            += device/oppo/find7/display/libgralloc
...
venc-test-inc                   += device/oppo/find7/display/libgralloc
venc-test-inc                   += $(venc-inc)

LOCAL_MODULE                    := mm-video-encdrv-test
LOCAL_MODULE_TAGS               := optional
LOCAL_C_INCLUDES                := $(venc-test-inc)
LOCAL_C_INCLUDES                += device/oppo/find7/media/mm-core/inc
