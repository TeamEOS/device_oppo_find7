...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.hardware=find7 androidboot.selinux=permissive user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3
...
# RIL
BOARD_RIL_CLASS := ../../../device/oppo/find7/ril/telephony/java/com/android/internal/telephony/OppoRIL.java
...
TARGET_ENABLE_DIRAC_AUDIO := true

# Display
TARGET_USES_LEGACY_HEAP_MASK := true
